...
<div class="row">
  <div class="col-md-6">
	...
	@endif
		...
		{!! Form::text('kodeproduk', null,['class' => 'form-control','autofocus'=>'autofocus']) !!}
...
<div class="row">
  <div class="col-md-6">
	...
	@endif
		...
		{!! Form::select('id_kategoriproduk', $list_kategoriproduk, $cat,['class' => 'form-control js-example-basic-single', 'id'=>'id_kategoriproduk','placeholder'=>'Pilih Kategori Produk']) !!}
		@else
